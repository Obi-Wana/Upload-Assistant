...
class AITHER():
    ...
    def __init__(self, config):
        ...
        self.signature = f"\n[center]Created by [url=https://aither.cc/forums/topics/1349]L4G's Upload Assistant[/url], customized by ATH[/center]"
    ...
    async def upload(self, meta):
        ...
        data = {
            ...
            'internal' : int(meta.get('internal', False)),
            'featured' : int(meta.get('featured', False)),
            'free' : 0,
            'doubleup' : 0,
            'sticky' : int(meta.get('sticky', False)),
            'exclusive': int(meta.get('exclusive', 0)),
        }
        headers = {
